...
//cout << "\n"; //TEST CODE
   ...
   */
   ...
   almostSorted(array, max, size); //This is seriously overengineered because I figured out a better way to do it 90% of the way through, but basically it generates a generally increasing array with some exceptions (that is, numbers smaller than the previous number)
}
