...
public:
   ...
   void deleteSmallest();
      //Function to delete smallest item form the list.
      //Postcondition: Once found, the node containing the smallest item
      //               is deleted from the list. First points to the first 
      //               node, last points to the last node of the updated
      //               list, and the count is decremented by 1.
...
void unorderedLinkedList<Type>::deleteSmallest()
{
   ...
   Type smallest; //storage variable for smallest value   
