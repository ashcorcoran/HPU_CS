...
public:
   ...
   void reverseStack(linkedStackType<Type> &otherStack);
     //function to reverse the contents of one stack into the other
...
{
      while(otherStack.stackTop != nullptr)
      {
         otherStack.pop();
      }
     
      linkedStackType<Type> copyStack = *this;

      while(copyStack.stackTop != nullptr)
      {
