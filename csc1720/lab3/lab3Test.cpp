/* Programmer: 
   Date: 
   Program: Lab 3 Test Program
   Filenames: lab3Test.cpp, counterType.h, counterTypeImp.cpp

   Description: This program tests each component of the counterType class.  The 
   expected output is given in the comments. Actual output should agree.
   
   Assistance received from:

   How to compile:
   g++ -Wall lab3Test.cpp counterType.cpp -o Lab3
